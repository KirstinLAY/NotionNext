...
const BLOG = {
  ...
  NOTION_PAGE_ID:
      process.env.NOTION_PAGE_ID || '479157a95de44aa6a646b908d34c6a3b',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，I am a master student in Chemical Engineering and Material Science, welcome!🎉',
  ...
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || 'https://linkedin.com/in/yunjielei', // 你的linkedIn 首页
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || 'https://instagram.com/kirstin_lay3?igshid=OGQ5ZDc2ODk2ZA==', // 您的instagram地址
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,wechat,email,facebook,twitter,messenger,whatsapp,linkedin', // 分享的服務，按顺序显示,逗号隔开
